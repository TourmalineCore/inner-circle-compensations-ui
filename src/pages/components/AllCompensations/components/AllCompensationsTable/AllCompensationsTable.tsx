    ...
    <table data-cy="all-compensations-table"
      ...
      <tfoot>
        <tr className="all-compensations-table__total"
          ...
          <th className="all-compensations-table__column-unpaid__sum"
            data-cy="all-compensations-table-unpaid-sum">{formatMoney(allCompensationsState.totalUnpaidCount)}</th>
