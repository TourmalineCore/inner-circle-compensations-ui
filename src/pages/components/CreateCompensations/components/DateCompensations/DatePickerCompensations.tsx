...
const DatePickerCompensationsCustomElement = forwardRef<HTMLButtonElement, HTMLProps<HTMLButtonElement>>(({
  value, onClick,
}, ref) => (
  <button
    type="button"
...
export const DatePickerCompensations = observer(() => {
  ...
  return (
    ...
    >
      ...
      <DatePicker
        selected={createCompensationsState.compensationRequestedForYearAndMonth as Date}
